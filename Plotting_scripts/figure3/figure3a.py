...
#%%
data2 = pd.read_csv('P_2.txt',sep='\s+',header=None)
data3 = pd.read_csv('P_4.txt',sep='\s+',header=None)
data4 = pd.read_csv('P_5.txt',sep='\s+',header=None)
data5 = pd.read_csv('P_6.txt',sep='\s+',header=None)
data6 = pd.read_csv('P_11.txt',sep='\s+',header=None)
data7 = pd.read_csv('P_13.txt',sep='\s+',header=None)
data8 = pd.read_csv('P_14.txt',sep='\s+',header=None)
data9 = pd.read_csv('P_15.txt',sep='\s+',header=None)
data10 = pd.read_csv('P_22.txt',sep='\s+',header=None)
data11 = pd.read_csv('P_26.txt',sep='\s+',header=None)
...
locs=[1,1.001,1.002,1.003,1.004,1.005,1.006,1.007,1.008,1.009,1.01,1.011]
...
plt.yticks(locs,[name0,name2,name3,name4,name5,name1,name6,name7,name8,name9,name10,name11],fontsize=FS-3)
plt.xlabel('AMOC [Sv]',fontsize=FS)
plt.xticks(fontsize=FS-3)
plt.title('Pre-Industrial configuration',fontsize=FS)
plt.grid()
plt.show()   
fig.savefig('figure3a.png', format='png', dpi=300)