...
#%%
data0 = pd.read_csv('P_A_Z_0a.txt',sep='\s+',header=None)
data1 = pd.read_csv('P_A_Z_1a.txt',sep='\s+',header=None)
data2 = pd.read_csv('P_A_Z_2a_2.txt',sep='\s+',header=None)
data3 = pd.read_csv('P_A_Z_3a.txt',sep='\s+',header=None)
data4 = pd.read_csv('P_A_z_4a.txt',sep='\s+',header=None)
data5 = pd.read_csv('P_A_Z_5a.txt',sep='\s+',header=None)
data6 = pd.read_csv('P_A_Z_6a.txt',sep='\s+',header=None)
...
data10 = pd.read_csv('P_A_Z_0b.txt',sep='\s+',header=None)
data11 = pd.read_csv('P_A_Z_1b.txt',sep='\s+',header=None)
data12 = pd.read_csv('P_A_Z_2b.txt',sep='\s+',header=None)
data13 = pd.read_csv('P_A_Z_3b.txt',sep='\s+',header=None)
data14 = pd.read_csv('P_A_Z_4b.txt',sep='\s+',header=None)
data15 = pd.read_csv('P_A_Z_5b.txt',sep='\s+',header=None)
data16 = pd.read_csv('P_A_Z_6b.txt',sep='\s+',header=None)
...
data20 = pd.read_csv('P_A_Z_0e.txt',sep='\s+',header=None)
data21 = pd.read_csv('P_A_Z_1e.txt',sep='\s+',header=None)
data22 = pd.read_csv('P_A_Z_2e.txt',sep='\s+',header=None)
data23 = pd.read_csv('P_A_Z_3e.txt',sep='\s+',header=None)
data24 = pd.read_csv('P_A_Z_4e.txt',sep='\s+',header=None)
data25 = pd.read_csv('P_A_Z_5e.txt',sep='\s+',header=None)
data26 = pd.read_csv('P_A_Z_6e.txt',sep='\s+',header=None)
...
plt.title('PI: Biological production',fontsize=FS)
...
plt.show()
fig.savefig('figure4c_rev.png', format='png', dpi=300)