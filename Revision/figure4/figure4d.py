...
data6 = pd.read_csv('L_A_Z_6a.txt',sep='\s+',header=None)
...
data16 = pd.read_csv('L_A_Z_6b.txt',sep='\s+',header=None)
...
data26 = pd.read_csv('L_A_Z_6e.txt',sep='\s+',header=None)
...
plt.show()
fig.savefig('figure4d_rev.png', format='png', dpi=300)