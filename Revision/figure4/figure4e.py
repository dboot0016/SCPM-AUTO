...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 29 10:19:10 2021
...
name2='PC-BIO-TEMP'
name3='PC-BIO-RAIN'
name4='PC-BIO-TEMP-PV'
name5='PC-BIO-TEMP(A)-EFF'
name6='PC-ALL'
...
#%%
data0 = pd.read_csv('P_A_P_0a.txt',sep='\s+',header=None)
data1 = pd.read_csv('P_A_P_1a.txt',sep='\s+',header=None)
data2 = pd.read_csv('P_A_P_2a.txt',sep='\s+',header=None)
data3 = pd.read_csv('P_A_P_3a.txt',sep='\s+',header=None)
data4 = pd.read_csv('P_A_P_4a.txt',sep='\s+',header=None)
data5 = pd.read_csv('P_A_P_5a.txt',sep='\s+',header=None)
data6 = pd.read_csv('P_A_P_6a.txt',sep='\s+',header=None)
...
data10 = pd.read_csv('P_A_P_0b.txt',sep='\s+',header=None)
data11 = pd.read_csv('P_A_P_1b.txt',sep='\s+',header=None)
data12 = pd.read_csv('P_A_P_2b.txt',sep='\s+',header=None)
data13 = pd.read_csv('P_A_P_3b.txt',sep='\s+',header=None)
data14 = pd.read_csv('P_A_P_4b.txt',sep='\s+',header=None)
data15 = pd.read_csv('P_A_P_5b.txt',sep='\s+',header=None)
data16 = pd.read_csv('P_A_P_6b.txt',sep='\s+',header=None)
...
data20 = pd.read_csv('P_A_P_0e.txt',sep='\s+',header=None)
data21 = pd.read_csv('P_A_P_1e.txt',sep='\s+',header=None)
data22 = pd.read_csv('P_A_P_2e.txt',sep='\s+',header=None)
data23 = pd.read_csv('P_A_P_3e.txt',sep='\s+',header=None)
data24 = pd.read_csv('P_A_P_4e.txt',sep='\s+',header=None)
data25 = pd.read_csv('P_A_P_5e.txt',sep='\s+',header=None)
data26 = pd.read_csv('P_A_P_6e.txt',sep='\s+',header=None)
...
for i in range(19):
   ...
   if np.size(data15.loc[data15[i+6] < 0])>0:
       print('15')
       print(i+6)
   if np.size(data16.loc[data16[i+6] < 0])>0:
       print('16')
       print(i+6)
   ...
   if np.size(data25.loc[data25[i+6] < 0])>0:
       print('25')
       print(i+6)
   if np.size(data26.loc[data26[i+6] < 0])>0:
       print('26')
       print(i+6)
...
t6=CO2_6[xP61:xP6]
x6=PAR_6[xP61:xP6]
y6=np.zeros(np.size(x6))+1.024

t16=CO2_16[xP161:xP16]
x16=PAR_16[xP161:xP16]
y16=np.zeros(np.size(x16))+1.025

t26=CO2_26[xP261:xP26]
x26=PAR_26[xP261:xP26]
y26=np.zeros(np.size(x26))+1.026
...
points16 = np.array([x16, y16]).T.reshape(-1, 1, 2)
segments16 = np.concatenate([points16[:-1], points16[1:]], axis=1)
...
points26 = np.array([x26, y26]).T.reshape(-1, 1, 2)
segments26 = np.concatenate([points26[:-1], points26[1:]], axis=1)

lc0 = LineCollection(segments0, cmap=plt.get_cmap('RdYlBu_r'),
    norm=plt.Normalize(120,275))
lc0.set_array(t0)
...
lc16 = LineCollection(segments16, cmap=plt.get_cmap('RdYlBu_r'),
    norm=plt.Normalize(120,275))
lc16.set_array(t16)
lc16.set_linewidth(LW)
...
lc26 = LineCollection(segments26, cmap=plt.get_cmap('RdYlBu_r'),
    norm=plt.Normalize(120,275))
lc26.set_array(t26)
lc26.set_linewidth(LW)
...
locs=[1,1.001,1.002,1.004,1.005,1.006,1.008,1.009,1.01,1.012,1.013,1.014,1.016,1.017,1.018,1.02,1.021,1.022,1.024,1.025,1.026]
...
plt.plot(xline,Y+0.023,'k',linewidth=0.75)

if log==1:
    plt.xscale('log')
    plt.text(5,0.99925,name0,fontsize=FS-7)
    plt.text(5,1.00325,name1,fontsize=FS-7)
    plt.text(2.8,1.00725,name2,fontsize=FS-7)
    plt.text(3,1.01125,name3,fontsize=FS-7)
    plt.text(2.1,1.01525,name4,fontsize=FS-7)
    plt.text(1.5,1.01925,name5,fontsize=FS-7)
    plt.text(5,1.02325,name6,fontsize=FS-7)
else:
...
plt.title('PI: Piston velocity',fontsize=FS)
...
plt.xlim(0.1, 10)
plt.ylim(0.999, 1.027)
plt.yticks(locs,['0','1','4','0','1','4','0','1','4','0','1','4','0','1','4','0','1','4','0','1','4'],fontsize=FS-7)
plt.ylabel('$\lambda_A$',fontsize=FS)
plt.xlabel('Multiplier',fontsize=FS)
plt.grid(True, which="major", ls="-")
plt.grid(True, which="minor", ls="--")
plt.show()
fig.savefig('figure4e_rev.png', format='png', dpi=300)