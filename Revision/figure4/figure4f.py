...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 29 11:23:42 2021
...
name2='LC-BIO-TEMP'
name3='LC-BIO-RAIN'
name4='LC-BIO-TEMP-PV'
name5='LC-BIO-TEMP(A)-EFF'
name6='LC-ALL'
...
#%%
data0 = pd.read_csv('L_A_P_0a.txt',sep='\s+',header=None)
data1 = pd.read_csv('L_A_P_1a.txt',sep='\s+',header=None)
data2 = pd.read_csv('L_A_P_2a.txt',sep='\s+',header=None)
data3 = pd.read_csv('L_A_P_3a.txt',sep='\s+',header=None)
data4 = pd.read_csv('L_A_P_4a.txt',sep='\s+',header=None)
data5 = pd.read_csv('L_A_P_5a.txt',sep='\s+',header=None)
data6 = pd.read_csv('L_A_P_6a.txt',sep='\s+',header=None)
...
data10 = pd.read_csv('L_A_P_0b.txt',sep='\s+',header=None)
data11 = pd.read_csv('L_A_P_1b.txt',sep='\s+',header=None)
data12 = pd.read_csv('L_A_P_2b.txt',sep='\s+',header=None)
data13 = pd.read_csv('L_A_P_3b.txt',sep='\s+',header=None)
data14 = pd.read_csv('L_A_P_4b.txt',sep='\s+',header=None)
data15 = pd.read_csv('L_A_P_5b.txt',sep='\s+',header=None)
data16 = pd.read_csv('L_A_P_6b.txt',sep='\s+',header=None)
...
data20 = pd.read_csv('L_A_P_0e.txt',sep='\s+',header=None)
data21 = pd.read_csv('L_A_P_1e.txt',sep='\s+',header=None)
data22 = pd.read_csv('L_A_P_2e.txt',sep='\s+',header=None)
data23 = pd.read_csv('L_A_P_3e.txt',sep='\s+',header=None)
data24 = pd.read_csv('L_A_P_4e.txt',sep='\s+',header=None)
data25 = pd.read_csv('L_A_P_5e.txt',sep='\s+',header=None)
data26 = pd.read_csv('L_A_P_6e.txt',sep='\s+',header=None)
...
plt.title('LGM: Piston velocity',fontsize=FS)
...
plt.show()
fig.savefig('figure4f_rev.png', format='png', dpi=300)