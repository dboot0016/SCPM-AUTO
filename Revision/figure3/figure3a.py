...
name8='P-BIO-BALK'
name9='P-BIO-RAIN'
name10='P-BIO-TEMP-PV'
name11='P-BIO-TEMP(A)-EFF'
name12='P-ALL'
...
data12 = pd.read_csv('P_ALL.txt',sep='\s+',header=None)
...
plt.grid()
plt.show()   
fig.savefig('figure3a_rev.png', format='png', dpi=300, bbox_inches = 'tight')