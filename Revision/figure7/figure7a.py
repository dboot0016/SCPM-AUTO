...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 08:49:26 2021
...
TA_2i1=(3446475.31695093e+12-(3349332.54317694e+12-TC_2i*(10**22))*2)
TA_2i=np.roll(TA_2i1,-jj)
# %%
...
ax1.set_ylabel('CO$_2$ [ppm]', color='tab:red',fontsize=FS)
ax1.plot(ti_2,CO2, color=color1,linewidth=LW)

ax1.tick_params(axis='y', labelcolor='tab:red', labelsize=FS-3)
ax1.tick_params(axis='x', labelsize=FS-3)
plt.xlim(0,max(ti_2))
plt.title('CO$_2$ and Total Alk',fontsize=FS)
plt.grid()

ax2 = ax1.twinx()  

color = 'tab:blue'
ax2.set_ylabel('Total Alk [Pmol]', color=color,fontsize=FS)  
ax2.plot(ti_2,TA_2i*1e-15, color=color,linewidth=LW)
ax2.tick_params(axis='y', labelcolor=color, labelsize=FS-3)
fig.tight_layout() 

plt.savefig('figure7a.png', format='png', dpi=300)