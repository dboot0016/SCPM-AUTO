!----------------------------------------------------------------------
!----------------------------------------------------------------------
!   SCPM: Simple Carbon Project model (PI configuration - other control parameters)
!----------------------------------------------------------------------
!----------------------------------------------------------------------
...
! State the parameters of the model (first general, than per box)
        ...
        TC1=ComC*(1d22)*par(1)+Ant               !41228.98598887 !41292.31401487               !  Total carbon in system (PgC)
        ...
        TP1=2.9622168229501007*(1d15)*par(1)           !2.962216822950195         ! Total phosphate in system
        ...
        TA1=3486246.73610888e+12-(3427697.69670697E+12-ComC*(1d22))*2*par(1)     !3496.2273805396426 !3506.772648675157                   ! Total alkalinity in system
       ...
       ! Piston velocity
        ...
        PV5=10**par(18)*(PV*PV_VAR*(((2116.8-136.25*T5+4.7353*T5**2-0.092307*T5**3+0.0007555*T5**4)/660)**-0.5)+PV*(1-PV_VAR))
...
! Parameters
      ...
      PAR(16) = 0
      PAR(17) = 0
      PAR(18) = 0 ! control parameter piston velocity
      PAR(19) = 0 ! control parameter rain ratio
      PAR(20) = 0 ! control parameter biological production
    
      
! Special solution from transient code
! NF_PI_v11: intial conditions
